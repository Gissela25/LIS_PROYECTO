<?php
  ...
  extract($_GET);
  $login_buffer= array();
  $login_buffer['Acceso']=4;
  $login_buffer['Code']=$code;
  $login_buffer['Nombre']="Google User";
  $_SESSION['login_buffer']=$login_buffer;
?>
<!DOCTYPE html>
<html lang="es">
...
<div class="d-flex justify-content-center">
        ...
        <img src="<?=PATH?>Assets/img/logo.PNG" class="rounded mx-auto d-block mb-3" alt="..." height="85px"
                    width="230px">   
                <form action="<?=PATH?>Usuarios/Main" class="formulario" method="POST" role="form"> 
                    <div class="form-group text-center">
                    </div>
                    <br>        
                    <div class="form-group text-center" >
                        <input type="submit" value="Acceder a SUMERSA" class="boton btn" id="Iniciar" name="Iniciar">
                    </div>
