    ...
    <div class="row mx-5 mt-1 my-4">
        <div class="col ml-5">
            <div class="row mt-3">
                ...
                {
                ?>
                <form method="POST" action="<?=PATH?>Clientes/Actualizando" enctype="multipart/form-data" class="">
                <?php
                   if(isset($errores))
                   {
                       if(count($errores)>0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group mx-sm-4 pt-3">
                                        ...
                                        <input type="text" class="form-control" value="<?=$cliente['DUI']?>" name="DUI"
                                            id="DUI">
                                    </div>
                                </td>
                                <td></td>
                                <td>
                                    <div class="form-group mx-sm-4 pt-3">
                                        ...
                                        value="<?=$cliente['Correo']?>" name="Correo" id="Correo">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group mx-sm-4 pt-3">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="7083-6536" name="Telefono" id="Telefono" value="<?=$cliente['Telefono']?>"> 
                                    </div>
                                </td>
                                <td></td>
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <div class="my-2">
                                            <input type="submit" name="Guardar" id="Guardar" class="btn boton "></input>
                                        </div>
                                    </div>
                                </td>
                            </tr>
