                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="?c=products&a=stokeloza">Lourdes</a></li>
                            <li><a class="dropdown-item" href="?c=products&a=stokeopza">Opico</a></li>
                            <li><a class="dropdown-item" href="?c=products&a=stokesaza">Santa Ana</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <table class="table table-bordered">
                   ...
                   ?>
                        <tr < id="id_<?=$r->ID_Producto?>">
                            ...
                            <td><?=$r->Cantidad_ZA?></td>
                            <td>
                                <a class="edit mx-3" href="?c=products&a=editza&id=<?=$r->ID_Producto?>"><i class="bi bi-pencil-square"></i> Editar
