            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="?c=products&a=stokestop">Santa Tecla</a></li>
                            <li><a class="dropdown-item" href="?c=products&a=stokessop">San Salvador</a></li>
                            <li><a class="dropdown-item" href="?c=products&a=stokeloop">Lourdes</a></li>
                ...
                <table class="table table-bordered">
                   ...
                   ?>
                        <tr < id="id_<?=$r->ID_Producto?>">
                            ...
                            <td><?=$r->Cantidad_OP?></td>
                            <td>
                                <a class="edit mx-3" href="?c=products&a=editop&id=<?=$r->ID_Producto?>"><i class="bi bi-pencil-square"></i> Editar
