            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="<?=PATH?>?c=products&a=stokestsa">Santa Tecla</a></li>
                            <li><a class="dropdown-item" href="<?=PATH?>?c=products&a=stokesssa">San Salvador</a></li>
                            <li><a class="dropdown-item" href="<?=PATH?>?c=products&a=stokelosa">Lourdes</a></li>
                            <li><a class="dropdown-item" href="<?=PATH?>?c=products&a=stokezasa">Zaragoza</a></li>
