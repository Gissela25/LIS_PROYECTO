        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    ?>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?=PATH?>Productos/Inventario/<?=$_SESSION['login_buffer']['Siglas']?>">Inventario General</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?=PATH?>Productos/Disponibles/<?=$_SESSION['login_buffer']['Siglas']?>"><?=$_SESSION['login_buffer']['Nombre_Sucursal']?></a>
                </li>
